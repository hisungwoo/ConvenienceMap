...
class ChangeType {
    fun changeType(type : String) : String {
        ...
        when (type) {
            ...
            "UC0G02" -> result = "유치원"
            "UC0A01" -> result = "수퍼마켓·일용품·소매점"
            "UC0A15" -> result = "지역아동센터"
            "UC0B01" -> result = "일반음식점"
            "UC0C02" -> result = "관람장"
            "UC0K03" -> result = "국민건강보험공단"
            "UC0G03" -> result = "초등학교"
            "UC0G08" -> result = "교육원·직업훈련소·학원"
            "UC0F01" -> result = "종합병원"
            "UC0F03" -> result = "격리병원"
            ...
            "UC0T02" -> result = "자연공원"
            "UC0V01" -> result = "기숙사"
            "UC0A02" -> result = "이용원·미용원·목욕장"
            "UC0O01" -> result = "방송국"
            "UC0C03" -> result = "집회장"
            "UC0H05" -> result = "이외 사회복지시설"
            "UC0I02" -> result = "자연권수련시설"
            "UC0K02" -> result = "금융업소 등 일반업무시설"
            "UC0F02" -> result = "병원·치과병원·한방병원·정신병원·요양병원"
            "UC0L02" -> result = "관광숙박시설(관광호텔, 콘도등)"
            "UC0N02" -> result = "운전학원"
            ...
            "UC0A07" -> result = "공공도서관"
            "UC0A14" -> result = "의원·치과의원·한의원·산후조리원"
            ...
            "UC0A06" -> result = "보건소"
            "UC0A13" -> result = "공중화장실"
            "UC0K01" -> result = "국가 또는 지자체 청사"
            "UC0K05" -> result = "한국장애인고용공단"
            "UC0G05" -> result = "고등학교"
            "UC0G06" -> result = "전문대학"
            "UC0G07" -> result = "대학교"
            "UC0S01" -> result = "장례식장"
            "UC0R01" -> result = "야외음악당·야외극장·어린이회관"
            "UC0D01" -> result = "종교집회장"
